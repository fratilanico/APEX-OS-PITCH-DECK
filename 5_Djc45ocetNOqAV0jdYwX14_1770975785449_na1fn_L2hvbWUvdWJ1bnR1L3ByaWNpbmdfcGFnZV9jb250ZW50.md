      ...
      <section className="mb-12 sm:mb-16 px-2 sm:px-0">
        ...
        >
          {[
            ...
            >
              <div
                className={`mx-auto mb-3 sm:mb-4 w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center bg-${item.color}-500/10 border border-${item.color}-500/20`}
              >

...
const menuItems = [
  ...
  { icon: GraduationCap, label: "Learning Tracks", path: "/app/tracks" },
      ...
      <div className="flex items-center justify-center min-h-screen bg-background">
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-4">
            <div className="h-16 w-16 rounded-2xl bg-primary/10 flex items-center justify-center glow-emerald">
            ...
            <p className="text-sm text-muted-foreground text-center max-w-sm">
              Sign in to access your personalized AI training dashboard, learning tracks, and chat playground.
            </p>
          </div>
          <Button
            onClick={() => {
